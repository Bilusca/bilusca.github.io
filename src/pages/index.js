...
const IndexPage = () => (
  <Layout>
    <BigCard>
      ...
      <Separator />
      <SocialMedia>
        <a href="https://github.com/Bilusca" target="_blank" rel="noopener noreferrer">
          <FiGithub size={'1.8em'} color={purpleBlue} />
        </a>
        <a href="https://www.linkedin.com/in/lucas-assis-vieira/" target="_blank" rel="noopener noreferrer">
